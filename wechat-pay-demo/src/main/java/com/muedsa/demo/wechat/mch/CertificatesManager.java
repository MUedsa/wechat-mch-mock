...
public class CertificatesManager {
     ...
     * 证书下载地址
     */
    private static String CERT_DOWNLOAD_PATH = "https://api.mch.weixin.qq.com/v3/certificates";
    ...
    public Verifier getVerifier(String merchantId) throws NotFoundException {
        ...
        return new CertificatesManager.DefaultVerifier(merchantId);
    }
    ...
    public static void updateCertDownloadPath(String certDownloadPath){
        CERT_DOWNLOAD_PATH = certDownloadPath;
    }
}
